        ...
        />
          ...
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <h3 className="font-bold text-3xl max-w-2xl mx-auto px-4 sm:px-6">
                Watch how Summary transforms <span className="bg-linear-to-r from-rose-500 to-rose-700 bg-clip-text text-transparent">this Next.js course PDF</span>{' '}into an easy-tooread summary!
            </h3>
            </div>
