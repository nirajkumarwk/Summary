...
},
{
    ...
    label: 'AI Analysis',
    description: 'Our advanced AI proccsses and analyzes your document instantly'
},
{
...
export default function HowItWorksSection() {
    ...
    <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6  lg:px-8 ">
        <div 
          ...
          <div 
            className="relative left-[calc(50%-3rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-linear-to-br from-emerald-500 via-teal-500 to-cyan-500 opacity-20 sm:left-[calc(40%-30rem)] sm:w-[40.1875rem]"
            style={{
                clipPath:
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mz-auto relative">
           {steps.map((step, index) => (
            <div className="relative flex items-stretch" key={index}>
            <StepItem key={index} {...step} />
            {index < steps.length -1 && (<div className="hidden md:block top-1/2 -right-4 transform -translate-y-1/2 z-10 absolute">
                <MoveRight 
                  size={32}
                  strokeWidth={1}
