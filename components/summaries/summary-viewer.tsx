...
export function SummaryViewer({ summary }: { summary: string }) {
  ...
  const sections = summary
    ...
    .filter(Boolean)
    .map(parseSection);
    // console.log('section', sections[2]);

  return (
    <Card className="relative px-2 h-[500px] sm:h-[600px] w-full xl:w-[600px] overflow-hidden bg-linear-to-br from-background via-background/95 to-rose-500/5 backdrop-blur-lg shadow-2xl rounded-2xl border border-rose-500/10">
