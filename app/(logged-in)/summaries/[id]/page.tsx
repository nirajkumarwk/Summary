...
export default async function SummaryPage(props: {
  ...
  return <div className="relative isolate min-h-screen bg-linear-to-b from-rose-50/40">
    ...
    <div className="container mx-auto flex flex-col gap-4 ">
     <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-12 lg:py-24">
        ...
        <div className="relative mt-4 sm:mt-8 lg:mt-16 ">
          <div className="relative p-4 sm:p-6 lg:p-8 bg-white/80 backdrop-blur-md rounded-2xl sm:rounded-3xl shadow-xl border border-rose-100/30 transition-all duration-300 hover:bg-white/90 max-w-4xl mx-auto">
